...
SeaSceneNode::SeaSceneNode(Application &app, IrrlichtDevice *device,
...
void SeaSceneNode::updateInfos() { _userPos = _app.getUserPosition(); }

void SeaSceneNode::setVisible(bool visible) { ISceneNode::setVisible(visible); }
...
void SeaSceneNode::render() {
    ...
    float bounds[]{static_cast<float>(_userPos.x - 10000),
