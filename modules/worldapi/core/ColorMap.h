...
namespace world {
	...
	position and color. Then a spatial interpolation is used to fill all the colormap.
	Then it's possible to retrieve the value at a special point calling the method
	getColorAt(). All the coordinates are bounded to [0, 1].
