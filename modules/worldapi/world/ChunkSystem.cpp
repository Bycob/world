...
namespace world {
    ...
    ChunkID::ChunkID(const vec3i &pos, int lod)
            : _pos(pos), _lod(lod) {
    ...
    std::pair<WorldZone, bool>
    ChunkSystem::getOrCreateNeighbourZone(const ChunkHandler &chunk, const vec3i &direction) {
    ...
    std::pair<WorldZone, bool> ChunkHandler::getOrCreateNeighbourZone(const vec3i &direction) {
    ...
    vec3d ChunkHandler::getRelativeOffset(const ChunkHandler &other) {
        // TODO
    ...
    vec3d ChunkHandler::getAbsoluteOffset() {
