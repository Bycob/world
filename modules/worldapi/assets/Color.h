...
namespace world {
    ...
    struct Color4u {
        ...
        void set(u32 r, u32 g, u32 b) {
            _color = assemble(r, g, b, getAlpha());
        }
        void set(u32 r, u32 g, u32 b, u32 a) {
            _color = assemble(r, g, b, a);
        }
    ...
    struct Color4d {
        ...
        Color4d(double r, double g, double b, double a = 1) : _r(r), _g(g), _b(b), _a(a) {}
    ...
    inline Color4d::operator Color4u() const {
        return {
                static_cast<u32>(_r * 255),
                static_cast<u32>(_g * 255),
                static_cast<u32>(_b * 255),
                static_cast<u32>(_a * 255)
        };
    }
}
