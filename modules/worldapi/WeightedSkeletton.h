...
public :
	...
	Node<T> * createChild(double weight = DEFAULT_WEIGHT, double x = 0, double y = 0, double z = 0);
	void addNeighbour(Node<T> * neighbour);
	Node<T> * createNeighbour(double weight = DEFAULT_WEIGHT, double x = 0, double y = 0, double z = 0);
...
private :
	...
	Node(double weight = DEFAULT_WEIGHT, double x = 0, double y = 0, double z = 0);
...
public:
	...
	Node<T> * getPrimaryNode() const {
		return _primaryNode.get();
	}
