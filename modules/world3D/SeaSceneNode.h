...
public:
    SeaSceneNode(Application & app, irr::IrrlichtDevice * device, irr::scene::ISceneNode* parent, irr::s32 id);
    ...
    const irr::core::aabbox3d<irr::f32>& getBoundingBox() const override { return _box; }
    irr::u32 getMaterialCount() const override { return 1; }
    irr::video::SMaterial& getMaterial(irr::u32 i) override { return _material; }
private:
    Application & _app;
